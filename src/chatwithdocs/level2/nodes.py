...
import re
from chatwithdocs.entities.normalize import normalize_for_match
from pathlib import Path

from chatwithdocs.obs.trace import trace_event
from chatwithdocs.entities.vocab import load_vocab
from chatwithdocs.entities.resolve import resolve_entities
from chatwithdocs.level2.state import L2State, Citation
from chatwithdocs.agent.agent import plan_question, looks_malicious  # reuse Level 1 planner
from chatwithdocs.sql.exec import run_query
from chatwithdocs.rag.retriever import retrieve
from chatwithdocs.level2.answer import (
